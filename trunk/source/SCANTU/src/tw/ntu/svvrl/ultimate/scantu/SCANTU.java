 ...
 *
 */
public class SCANTU implements IController<RunDefinition> {

	public static final String PLUGIN_ID = "tw.ntu.svvrl.ultimate.scantu";
	public static final String PLUGIN_NAME = "SCANTU";
